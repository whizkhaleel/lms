...
-- ── Ensure payment_method enum exists for gateway-originated payments ──
DO $$ BEGIN
  CREATE TYPE payment_method AS ENUM ('cash', 'bank_transfer', 'card_gateway', 'bank_transfer_gateway', 'ussd');
